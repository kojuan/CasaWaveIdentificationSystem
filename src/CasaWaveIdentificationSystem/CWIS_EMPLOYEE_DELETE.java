 ...
 */
public final class CWIS_EMPLOYEE_DELETE extends javax.swing.JFrame {
    ...
    private void searchEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchEmployeeButtonActionPerformed
        ...
        try {
            ...
            String password = "root";
            // employeeID search
            try ( Connection conn = (Connection) DriverManager.getConnection("jdbc:mysql://localhost:3306/casawave_identification_system_database", username, password)) {
                // employeeID search
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CWIS_EMPLOYEE_DELETE().setVisible(true);
            }
        });
    }
