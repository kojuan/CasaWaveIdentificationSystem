 ...
 */
public final class CWIS_EMPLOYEE_UPDATE extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        employeeRagistrationImageLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/mainprogram/CWIS_TOPPANEL_UPDATEEMPLOYEE_fit.png"))); // NOI18N
...
//                            pstmt = conn.prepareStatement(sql);
                        pstmt = CASAWAVE_IDENTIFICATION_SYSTEM_DATABASE.getConnection().prepareStatement(sql);
                        // set parameters
                        ...
                        try {
                            ...
                            if (pstmt.executeUpdate() != 0) {   // IF successful update
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CWIS_EMPLOYEE_UPDATE().setVisible(true);
            }
        });
    }
