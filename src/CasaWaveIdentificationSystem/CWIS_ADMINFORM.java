 ...
 * @author Khian Orland
 */
public class CWIS_ADMINFORM extends javax.swing.JFrame {

    /**
     * Creates new form HMS_ADMINTOOLFORM
     */
    public CWIS_ADMINFORM() {
    ...
    private void initComponents() {
        ...
        adminToolHeader.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/login_images/CWIS_TOPPANEL_ADMINFORM.png"))); // NOI18N
        ...
        registerEmployeeButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/mainprogram/registerIcon.png"))); // NOI18N
        ...
        manageDatabaseURL.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/mainprogram/hyperlinkIcon.png"))); // NOI18N
        ...
        manageUserButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/mainprogram/userIcon.png"))); // NOI18N
        ...
        registerUserInDatabaseButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/CasaWaveIdentificationSystem/APP_IMAGES/mainprogram/registerIcon.png"))); // NOI18N
    ...
    private void registerEmployeeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerEmployeeButtonActionPerformed
        CWIS_EMPLOYEE_REGISTRATION employeeRegistrationForm = new CWIS_EMPLOYEE_REGISTRATION();
    ...
    private void registerEmployeeButtonKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_registerEmployeeButtonKeyPressed
        if (evt.getKeyCode() == KeyEvent.VK_ESCAPE) {
            this.dispose();
            CWIS_LOGIN showLoginScreen = new CWIS_LOGIN();
    ...
    private void adminCancelButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_adminCancelButtonActionPerformed
        CWIS_LOGIN mainLoginForm = new CWIS_LOGIN();
    ...
    private void manageUserButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageUserButtonActionPerformed
        try {
            ...
            Desktop.getDesktop().browse(new URI("http://localhost/phpmyadmin/sql.php?db=casawave_identification_system_database&table=users&pos=0"));
    ...
    private void manageEmployeesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_manageEmployeesButtonActionPerformed
        CWIS_EMPLOYEE_LIST showEmployeeListForm = new CWIS_EMPLOYEE_LIST();
    ...
    private void registerUserInDatabaseButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_registerUserInDatabaseButton1ActionPerformed
        this.dispose();
        CWIS_USER_REGISTRATION registerForm = new CWIS_USER_REGISTRATION();
...
//    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new CWIS_ADMINFORM().setVisible(true);
            }
        });
    }
