 ...
 * @author khian
 */
public class CWIS_PATIENT_MANAGEMENTSYSTEM extends javax.swing.JFrame {
     ...
     */
    public CWIS_PATIENT_MANAGEMENTSYSTEM() throws Exception {
    ...
    private void addButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addButtonActionPerformed
        if (image_path == null) {
            ...
            try {
                ...
                Logger.getLogger(CWIS_PATIENT_MANAGEMENTSYSTEM.class.getName()).log(Level.SEVERE, null, ex);
            }
        }
...
//            }
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> {
            try {
                new CWIS_PATIENT_MANAGEMENTSYSTEM().setVisible(true);

            } catch (Exception ex) {
                Logger.getLogger(CWIS_PATIENT_MANAGEMENTSYSTEM.class
